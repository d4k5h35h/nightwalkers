...
var gameState = 0.1;
var particles = [];
let b1img,b2img,b3imgb4img,b5img;
var music1, sfx1, voice;
...
function preload(){
  ...
  //animations
  idle = loadAnimation("player/idle(1).png", "player/idle(2).png", "player/idle(3).png", "player/idle(4).png", "player/idle(5).png", "player/idle(6).png", "player/idle(7).png", "player/idle(8).png", "player/idle(9).png", "player/idle(10).png");
  jump = loadAnimation("player/jump(1).png", "player/jump(2).png", "player/jump(3).png", "player/jump(4).png", "player/jump(5).png", "player/jump(6).png", "player/jump(7).png", "player/jump(8).png", "player/jump(9).png", "player/jump(10).png");
  run = loadAnimation("player/run(1).png", "player/run(2).png", "player/run(3).png", "player/run(4).png", "player/run(5).png", "player/run(6).png", "player/run(7).png", "player/run(8).png", "player/run(9).png", "player/run(10).png");
  hit = loadAnimation("player/hit(1).png", "player/hit(2).png", "player/hit(3).png", "player/hit(4).png", "player/hit(5).png", "player/hit(6).png", "player/hit(7).png", "player/hit(8).png", "player/hit(9).png", "player/hit(10).png");
  attack = loadAnimation("player/attack(1).png", "player/attack(2).png", "player/attack(3).png", "player/attack(4).png", "player/attack(5).png", "player/attack(6).png", "player/attack(7).png", "player/attack(8).png", "player/attack(9).png", "player/attack(10).png");
  ...
  voice = loadSound('mp3/player.ogg', loaded);
}
...
function draw(){
  ...
  */
  ...
  push();
  translate(width / 1.5, height / 2 - 100);
  animation(idle,0,0);
